...
?>
	...
	<h2 class="page-title">
		...
		<div class="breadcrumbs">
			...
			<span class="current-page">Edit Offical</span>
		</div>
	</h2>
	<div class="row add-entry-wrap clearfix">
		<h3 class="section-title">
			<i class="fa fa-bookmark"></i> <i class="fa fa-plus fa-action"></i> Edit Official
			<?php echo anchor('admin/officials', '<i class="fa fa-angle-left fwb"></i>Cancel', array('class' => 'gray-btn dgray'));?>
			<?php echo anchor('admin/voters/delete', '<i class="fa fa-trash-o fwb"></i>Delete', array('class' => 'red-btn'));?>
		</h3>
