...
?>
	...
	<div class="breadcrumbs">
		...
		<span class="current-page"><?php echo $barangay->name; ?></span>
	</div>
	</h2>
	...
	<div class="row dashboard-wrap clearfix"> <!-- Barangay Profile -->
		<h3 class="section-title">
			...
			<?php echo anchor('admin/barangays/edit?id='. $barangay->ID, '<i class="fa fa-pencil"></i>Edit', array('class' => 'gray-btn'));?>
		</h3>
		<div class="col one_half">
			<div class="section-wrap">
				<h3 class="city-name"><?php echo $barangay->name; ?></h3>
				<ul class="details-list">
					<li>District: <?php echo $barangay->district; ?></li>
					<li>Date Founded: <?php echo $barangay->date_founded; ?></li>
				</ul>
				<ul class="details-list">
					<li>Population: <?php echo $barangay->pp_population; ?></li>
					<li>Land Area: <?php echo $barangay->land_area; ?> sq km</li>
				</ul>
			</div>
			<div class="section-wrap">
				<h3 class="section-title"><i class="fa fa-flag"></i> Political Profile:</h3>
				<span class="city-mayor">Barangay Captain: Juan dela Cruz</span> <!-- to be queried -->
				<ul class="details-list">
					<li>Registered voters: 124, 805</li> <!-- to be queried -->
					<li>Voter Turn-out: 108, 357 - 90%</li> <!-- to be queried -->
				</ul>
			</div>
		</div>
	...
	<div class="row official-list clearfix"><!-- Barangay Officials -->
		<h3 class="section-title">
			...
			<?php echo anchor('admin/officials/add?barangay_id='. $barangay->ID, '<i class="fa fa-plus"></i>Add Official', array('class' => 'gray-btn'));?>
		</h3>
		<div class="data-list">
			<table class="tblue">
				<thead>
	...
	<div class="row official-list clearfix"><!-- Functionalities -->
		<h3 class="section-title">
			...
			<?php echo anchor('admin/officials/add?barangay_id='.$barangay->ID , '<i class="fa fa-plus"></i>Add Officer', array('class' => 'gray-btn'));?>
		</h3>
		<div class="data-list">
			<table class="torange">
				<thead>
	...
	<div class="row official-list clearfix"><!-- Voters -->
		<h3 class="section-title">
			...
			<?php echo anchor('admin/voters/add?barangay_id='. $barangay->ID, '<i class="fa fa-plus"></i>Add Voter', array('class' => 'gray-btn'));?>
